...
export default function HomePage() {
  ...
  return (
    <main className="bg-black text-white min-h-screen w-full p-6">
      {/* ---------------- HERO SECTION ---------------- */}
      <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 bg-black min-h-[400px] md:min-h-[500px] lg:min-h-[600px]">
        <h2 className=" hidden md:block bg-clip-text text-transparent text-center bg-gradient-to-b from-neutral-600 to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
          Jeet Library
        </h2>
        <p className="max-w-xl mx-auto text-sm md:text-lg text-white  text-center hover:text-cyan-400 transition-colors duration-300 z-10">
